...
import 'package:core/domain/entities/tv_show.dart' as i4;
...
class _FakeGetWatchlistTVShows_0 extends i1.Fake
    implements i2.GetWatchlistTv {}

/// A class which mocks [WatchlistTVShowNotifier].
///
/// See the documentation for Mockito's code generation for more information.
class MockWatchlistTVShowNotifier extends i1.Mock
    implements i3.WatchlistTvNotifier {
  MockWatchlistTVShowNotifier() {
    i1.throwOnMissingStub(this);
  }

  @override
  i2.GetWatchlistTv get getWatchlistTv => (super.noSuchMethod(
      Invocation.getter(#getWatchlistTVShows),
      returnValue: _FakeGetWatchlistTVShows_0()) as i2.GetWatchlistTv);
  @override
  List<i4.TvShow> get watchlistTv =>
      (super.noSuchMethod(Invocation.getter(#watchlistTVShows),
          returnValue: <i4.TvShow>[]) as List<i4.TvShow>);
  @override
  ...
  bool get hasListeners =>
      (super.noSuchMethod(Invocation.getter(#hasListeners), returnValue: false)
          as bool);
  @override
  i6.Future<void> fetchWatchlistTv() =>
